export const activitiesData = [
  {
    ...
    title: "Art & Craft",
    category: "Creative",
    description: "Encouraging creativity and self-expression through colors, shapes and textures.",
    icon: "Palette",
    color: "#541221",
    bgSoft: "#FDF6F7",
  ...
  },
  {
    ...
    title: "Music & Dance",
    category: "Creative",
    description: "Building rhythm, coordination, and confidence through music and movement.",
    icon: "Music",
    color: "#E67E22",
    bgSoft: "#FEF9F5",
  ...
  },
  {
    ...
    category: "Cognitive",
    description: "Enhancing language skills, imagination and listening through stories and rhymes.",
    icon: "BookOpen",
    color: "#2980B9",
    bgSoft: "#EBF5FB",
  ...
  },
  {
    ...
    category: "Physical",
    description: "Promoting teamwork, motor skills and a healthy body through fun games.",
    icon: "Activity",
    color: "#27AE60",
    bgSoft: "#F4FAF6",
  ...
  },
  {
    ...
    category: "Cognitive",
    description: "Nurturing curiosity and exploration through hands-on sensory experiences.",
    icon: "Fingerprint",
    color: "#8E44AD",
    bgSoft: "#F5EEF8",
  ...
  },
  {
    ...
    category: "Social",
    description: "Learning culture, values and traditions through joyful festival celebrations.",
    icon: "Sparkles",
    color: "#C0392B",
    bgSoft: "#FDEDEC",
  ...
  },
  {
    ...
    category: "Social",
    description: "Building confidence, communication skills and positive self-image through engaging activities.",
    icon: "Smile",
    color: "#D4AF37",
    bgSoft: "#FFFDF5",
  ...
  },
  {
    ...
    category: "Cognitive",
    description: "Exploring concepts through fun crafts, projects and interactive learning.",
    icon: "Lightbulb",
    color: "#16A085",
    bgSoft: "#E8F8F5",
  ...
  },
  {
    ...
    category: "Physical",
    description: "Strengthening fine and gross motor skills for better coordination and balance.",
    icon: "Compass",
    color: "#2C3E50",
    bgSoft: "#F2F4F4",
